...
namespace Animation
{
    class Cloud : Object
    {
        public Cloud(string name, int scaleX, int scaleY, int x, int y)
        ...
        protected override void DrawObject(Graphics g)
        {
            ...
            GraphicsPath Cloud = new GraphicsPath();
            SolidBrush CloudColor = new SolidBrush(Color.FromArgb(255, 255, 255));
            PointF[] c1 =
            {
                transformed[1], 
                transformed[2], 
